...
let Saving = {
	...
	fixSave() {
		...
		player.accelerator = player.accelerator ?? {};
		player.accelerator.unlocked = player.accelerator.unlocked ?? false;
		player.accelerator.particlesUnlocked = player.accelerator.particlesUnlocked ?? false;
		player.accelerator.protons = new Decimal(player.accelerator.protons) ?? new Decimal(0);
		player.accelerator.neutrons = new Decimal(player.accelerator.neutrons) ?? new Decimal(0);
		player.accelerator.electrons = new Decimal(player.accelerator.electrons) ?? new Decimal(0);
		player.accelerator.hydrogen = new Decimal(player.accelerator.hydrogen) ?? new Decimal(0);
		player.accelerator.protonUpgrades = player.accelerator.protonUpgrades ?? [false,false,false,false];
		player.accelerator.neutronUpgrades = player.accelerator.neutronUpgrades ?? [false,false,false,false];
		player.accelerator.electronUpgrades = player.accelerator.electronUpgrades ?? [false,false,false,false];
		player.accelerator.hydrogenUpgrades = player.accelerator.hydrogenUpgrades ?? [0,0,0,0,0,0];
		player.accelerator.elementUpgradeAutobuy = player.accelerator.elementUpgradeAutobuy ?? true;
